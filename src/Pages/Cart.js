    ...
    return (
        <Container className="py-4 mt-5">
            <h1 className={`${theme? 'text-light': 'text-light-primary'} my-5 text-center`}>
                {isEmpty? 'Tu carrito esta vacio' : 'Tu Carrito'}
            </h1>
            <Row className="justify-content-center">
                            ...
                            return(
                                <tr key={index}>
                                    ...
                                    <td>
                                        ...
                                        <Button onClick={()=> updateItemQuantity(item.id, item.quantity + 1)} className="ms-2">+</Button>
                                        <Button variant="danger" onClick={()=> removeItem(item.id)} className="ms-2">Quitar Articulo</Button>
                                    </td>
                                </tr>
                            )
                        })}
                ...
                {!isEmpty &&
                    ...
                    >
                        <Col className="py-2">
                            <h4>Precio Total: ARS {cartTotal}</h4>
                        </Col>
